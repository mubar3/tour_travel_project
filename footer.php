<footer class="main-footer" style="margin-left: 0px; background-color: #00a65a;color: #fff;">
  <div class="pull-right hidden-xs">
    <!-- <marquee behavior="scroll" direction="left" onmouseover="this.stop();" onmouseout="this.start();"> -->Powered by KARTANU<!-- </marquee> -->
  </div>
  <b><img src="assets/img/logo/<?php echo "$i[gambar] "; ?>" width="40px"> <?php $i = mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM identitas LIMIT 1"));  echo "$i[nama] "; ?> <i class="fa fa-copyright"></i> Copyright <?php echo date("Y");?></b>.
</footer>
  </div>
