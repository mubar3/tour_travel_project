  ...
  <div class='login-box-body' style="border-top: 8px solid #00a65a;border-bottom: 8px solid #00a65a;border-top-right-radius: 16px;border-top-left-radius: 16px;border-bottom-right-radius: 16px;border-bottom-left-radius: 16px;box-shadow: 0px 3px 6px 0px #222;">
    ...
    <form role="form" action="" method="post" autocomplete="off">
      ...
      <div class='form-group has-feedback'>
        <input type="text" class="form-control" placeholder="Masukan NIK" aria-describedby="basic-addon1" name="nik" required autofocus />
      ...
      <div class='row'>
        <div class='col-xs-12'>
          <button name="login" type='submit' class='btn bg-orange btn-block'><i class="fa fa-sign-in"></i> CEK</button>
          <a href="login" class='btn bg-green btn-block'><i class="fa fa-users"></i> LOGIN</a>
        </div>
      </div>
    </form>
    ...
    <footer><br>
      <center>Copyright <i class="fa fa-copyright"></i> <?php echo date("Y");?>.<br><b> <?php echo "$i[sekolah] "; ?></b>
