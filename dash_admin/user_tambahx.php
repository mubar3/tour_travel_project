      ...
      <div class='row'>
          ...
          <div class='box box-success'>
            ...
            <form class='form-horizontal' role='form' method=POST action='aksi/user_simpanx.php' enctype='multipart/form-data'>
              ...
              <div class='form-group'>
                ...
                <div class='col-sm-10'>
                  <input type='text' class='form-control' name='e' placeholder='Tuliskan Nama Lengkap'>
                </div>
              </div>
              <div class='form-group'>
        ...
        <div class='box-footer'>
          ...
          <div class='col-sm-10'>
            ...
            <a style='width: 150px;' href="view-user" type="button" class="btn btn-flat btn-danger"><i class="glyphicon glyphicon-floppy-remove"></i> B A T A L</a>
          </div>
        </div>
      </form>
    </div>
