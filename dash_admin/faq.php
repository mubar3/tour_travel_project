      ...
      <div class="row">
        <div class="col-md-4">
          <div class="box box-solid box-default">
            <div class="box-header">
              <h3 class="box-title">Bagaimana Cara Ganti Nama Aplikasi?</h3>
            </div><!-- /.box-header -->
            <div class="box-body">
              <ol>
                <li>Klik Menu Pengaturan.</li>
        ...
        <div class="col-md-4">
          <div class="box box-solid box-danger">
            <div class="box-header">
              <h3 class="box-title">Bagaimana Cara Cetak Kartu?</h3>
            </div><!-- /.box-header -->
            <div class="box-body">
               <ol>
        ...
        <div class="col-md-4">
          <div class="box box-solid box-primary">
            <div class="box-header">
              <h3 class="box-title" style="font-size: 17px;">Bagaimana Cara Tambah Data?</h3>
            </div><!-- /.box-header -->
            <div class="box-body">
               <ol>
                <li>Klik Menu Tambah Data.</li>
                <li>Isi Data Dan Lengkapi Semua Form Isian.</li>
