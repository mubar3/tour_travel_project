            ...
            <form class='form-horizontal' role='form' method=POST action='aksi/user_updatex.php' enctype='multipart/form-data'>
              <div class='box-body'>
                ...
                $rr=mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM userr 
                  INNER JOIN level ON userr.id_level= level.id_level
                  INNER JOIN kelurahan ON userr.id_kel= kelurahan.id_kel
                  INNER JOIN kabupaten ON userr.id_kab= kabupaten.id_kab 
                  INNER JOIN kecamatan ON userr.id_kec= kecamatan.id_kec 
                  INNER JOIN provinsi ON userr.id_prov= provinsi.id_prov WHERE id='$_GET[id]'"));
                  ?>
                ...
                <div class='form-group'>
                  ...
                  <div class='col-sm-4'>
                    <input type='text' name='b' class='form-control' value="<?php echo $rr['username']; ?>">
                  </div>
                ...
                <div class='form-group'>
                  ...
                  <div class='col-sm-4'>
                    <input type='text' class='form-control' name='c' value="<?php echo $rr['nama']; ?>">
                  </div>
                </div>
                ...
                <div class='form-group'>
                  ...
                  <div class='col-sm-4'>
                    <input class='form-control' name='d' value="<?php echo $rr['tmp_lhr']; ?>">
                  </div>
                  <label class='col-sm-2 control-label'>Tanggal Lahir : </label>
                  <div class='col-sm-4'>
                    <input type='date' class='form-control' name='e' value="<?php echo $rr['tgl_lhr']; ?>">
                  </div>
                </div>
                ...
                <div class='form-group'>
                  ...
                  <div class='col-sm-4'>
                    <textarea class='form-control' name='f' value="<?php echo $rr['alamat']; ?>"><?php echo $rr['alamat']; ?></textarea>
                  </div>
