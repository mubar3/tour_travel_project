...
// $pekerjaan       = mysqli_query($koneksi, "SELECT * FROM tb_pekerjaan where pekerjaan='nelayan' order by id ");
// $x=0; 
//               while ($b = mysqli_fetch_array($pekerjaan)) { 
//                 // echo '"' . $b['pekerjaan']. '"';
//                       if($x==0){
//                       echo "'".$b['pekerjaan']."'";  
//                       }else{
...
//                       }
//                       $x++;            } 
// $query2 = "SELECT (SELECT COUNT(jk) FROM user WHERE jk = 'laki-laki') as TotalJk FROM `user`";
