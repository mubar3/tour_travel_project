                ...
                <thead class="bg-red">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td width="100px">
                        <a class='btn bg-aqua btn-sm' data-toggle='tooltip' title='Klik untuk Unggah/ganti Tanda Tangan' href='tandatangan_kab.php?id=<?php echo $rr["id_kab"];?>'><span class='glyphicon glyphicon-edit'></span></a>
                      </td>
                    <?php  $no++; } ?>
                    </tr>
                  </tbody>
