    ...
    for($i=0; $i < $N; $i++)
    {
        ...
        while($r=mysqli_fetch_array($data))
        {
            ...
            <div style="margin-top:-18px;width: 850px;height: 260px;margin-bottom: -12px;background-image: url('../assets/img/blangko/<?php echo $blangko["gambar"];?>');">
                ...
                <p style="font-family: arial;font-size: 9px;position: absolute;margin-left: 40px;margin-top: 140px;width: 180px;height:30px;text-align:center;position: center;float: center">
                    <u><b><?php echo $blangko["kepsek"];?></b></u><br><?php echo $blangko["nip"];?>
                </p>

                 <p style="font-family: arial;font-size: 7px;position: absolute;margin-left: 110px;margin-top: 110px;width: 80px;height:20px;text-align:center;position: center;float: center">
                ...
                <p style="font-family: arial;font-size: 7px;position: absolute;margin-left: 210px;margin-top: 110px;width: 50px;height:10px;text-align:center;position: center;float: center">
                    <img src="../assets/img/tandatangan/<?php echo $cap["gambar"];?>">

                   <p style="font-family: arial;font-size: 7px;position: absolute;margin-left: 275px;margin-top: 110px;width: 80px;height:10px;text-align:center;position: center;float: center">
            ...
            <!-- <?php
                ...
                <table cellpadding="1" cellspacing="1em" style="margin-top: 0px; padding-left: 120px; position: relative;font-family: arial;font-size: 10px;transition-property: 500px;width: 390px;height: 110px;"> 
                    <tr>
                        <td>Nomor Induk Anggota</td>
                        <td>:</td>
                        <td style="font-size: 12px;"><b><?php echo "$r[id_kel]";?>.<?php echo "$r[jenjang]";?>.<?php echo $ti;?>.<?php echo "$r[no_anggota]";?></b></td>
                    </tr> 
                    <tr>
                        <td>NIK</td>
                        <td>:</td>
                ...
                <p style="color: #FFFFFF;margin-top: -190px;padding-left: 600px;padding-top: 4px;font-size: 11px;"> <b style="font-size: 18px;"><?php echo $blangko["judul"];?></b>
