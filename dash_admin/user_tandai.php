              ...
              <div class="table-responsive">
                ...
                <table class="table table-bordered table-hover">
                 ...
                 <!--     <th>WAKTU INPUT</th> -->
                  ...
                  left JOIN provinsi ON user.id_prov= provinsi.id_prov WHERE mwc='$_POST[kecamatan]' and status_cetak=0 Order by no_anggota DESC");
                  }
                  ...
                  left JOIN kabupaten ON user.id_kab= kabupaten.id_kab 
                  left JOIN kecamatan ON user.id_kec= kecamatan.id_kec 
                  left JOIN provinsi ON user.id_prov= provinsi.id_prov WHERE mwc='$_POST[kecamatan]' and ranting='$_POST[kelurahan]' and status_cetak=0 Order by no_anggota DESC");
                  }
