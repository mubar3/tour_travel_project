              ...
              <form class='form-horizontal' role='form' method=POST action='aksi/identitas_update.php' enctype='multipart/form-data'>
                <div class='box-body'>
                  ...
                  <div class='form-group'>
                    <label class='col-sm-3 control-label'>Nama Singkat Aplikasi :</label>
                    <div class='col-sm-6'>
                  ...
                  <div class='form-group'>
                    <label class='col-sm-3 control-label'>Keterangan Aplikasi :</label>
                    <div class='col-sm-6'>
                    ...
                    <div class='col-sm-3'>
                      <div class="panel panel-primary">
                       <div class="panel-heading">
                        <h3 class="panel-title"><i class="fa fa-hand-o-down"></i> Logo Saat ini</h3>
                      </div>
                      <div class="panel-body">
                       <center> <img class="bg-green img-rounded" width='100' src="../assets/img/logo/<?php echo "$r[gambar]";?>" alt="" class="img-responsive img-thumbnail"></div><center>
                       </div>
                     </div>
                     <div class='col-sm-3'>
